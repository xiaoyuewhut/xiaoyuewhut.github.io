---
title: "ALC 功能规范"
slug: "智驾系统开发/alc-功能规范"
published: 2026-05-03
updated: 2026-05-03
description: "本文档面向整车功能定义、ADAS 系统设计、HMI 定义、LKA / LCA / BSD 协同开发、EPS 联调、底盘联调、测试验证和项目管理使用。后续软件需求、标定参数、通信矩阵、诊断规范和测试用例应基于本文档继续分解。"
tags: ["功能规范", "ALC", "命令变道", "L2", "辅助驾驶", "智能驾驶", "行车"]
category: "智驾系统开发"
draft: false
---
