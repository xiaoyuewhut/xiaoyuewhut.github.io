---
title: "ACC功能规范"
slug: "智驾系统开发/acc-功能规范"
published: 2026-04-16
updated: 2026-04-16
description: "本文档定义乘用车高级驾驶辅助系统中的自适应巡航控制功能。ACC 的职责是在满足系统可用条件时，对车辆纵向运动进行自动控制，使车辆能够按照驾驶员设定的巡航速度行驶，或者按照设定的车间时距跟随前车，并在前车减速、停车、再起步的过程中维持连续的跟车控制。"
tags: ["功能规范", "自适应巡航控制", "L2", "辅助驾驶", "智能驾驶", "自动驾驶", "行车"]
category: "智驾系统开发"
draft: false
---
# ACC 功能规范
